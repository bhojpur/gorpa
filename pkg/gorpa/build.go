...
import (
	...
	"github.com/bhojpur/gorpa/pkg/gokart"
...
func (p *Package) buildYarn(buildctx *buildContext, wd, result string) (err error) {
	...
	if cfg.Packaging == YarnApp {
		...
		// The yarn package name and Bhojpur GoRPA package name do not have to be the same which makes it possible to "reuse" the npm package name for

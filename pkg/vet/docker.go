...
func init() {
	register(PackageCheck("copy-from-pacakge", "attempts to find broken package paths in COPY and ADD statements", gorpa.DockerPackage, checkDockerCopyFromPackage))
}
